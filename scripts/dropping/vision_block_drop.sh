...
drop_n=4
model_name=dinov2
# Options: dinov3_vit, vit, swinv2

model_name_or_path=facebook/dinov2-giant-imagenet1k-1-layer
#  Options: facebook/dinov3-vitl16-pretrain-lvd1689m, google/vit-base-patch16-224, microsoft/swinv2-base-patch4-window12-192-22k
