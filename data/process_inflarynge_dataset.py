"""Process InfLarynge dataset (.mat) into train/val/test H5 splits.
...
Usage:
    python data/process_pest_dataset.py --mat_path DatasColor_62.mat --output_dir data/InfLarynge
"""
import argparse
import h5py
import json
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="data/InfLarynge")
    parser.add_argument("--fold", type=int, default=0)
    args = parser.parse_args()

    output_dir = Path(args.output_dir)
    print(f"{'='*60}")
    print(f"Processing InfLarynge dataset")
    print(f"{'='*60}")
