...
_TRAIN_SPARSE_ARGS = [ModelArguments, DataArguments, Seq2SeqTrainingArguments, FinetuningArguments, PruningArguments]
_TRAIN_SPARSE_CLS = Tuple[ModelArguments, DataArguments, Seq2SeqTrainingArguments, FinetuningArguments, PruningArguments]
...
def get_train_sparse_args(args: Optional[Dict[str, Any]] = None) -> _TRAIN_SPARSE_CLS:
    ...
    model_args, data_args, training_args, finetuning_args, pruning_args = _parse_args(parser, args)
    ...
    return model_args, data_args, training_args, finetuning_args, pruning_args
