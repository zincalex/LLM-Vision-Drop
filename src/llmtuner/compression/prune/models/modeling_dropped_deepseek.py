...
class DeepseekV3Attention(nn.Module):
    ...
    def __init__(self, config: DeepseekV3Config, layer_idx: Optional[int] = None, kv_cache_idx: Optional[int] = None):
        super().__init__()
        self.config = config
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if past_key_values is not None:
            ...
            key_states, value_states = past_key_values.update(key_states, value_states, self.kv_cache_idx, cache_kwargs)  # 🔍 use kv_cache_idx
...
class DeepseekV3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: DeepseekV3Config, layer_idx: int):
        ...
        if self.drop_attn:
            ...
            self.self_attn = DeepseekV3Attention(config=config, layer_idx=layer_idx, kv_cache_idx=self.kv_cache_idx)
