...
from .configuration_dropped_gemma3 import Gemma3Config, Gemma3TextConfig
...
class Gemma3Attention(nn.Module):
    ...
    def __init__(self, config: Gemma3TextConfig, layer_idx: int, kv_cache_idx: Optional[int] = None):
        super().__init__()
...
class Gemma3DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Gemma3TextConfig, layer_idx: int):
        ...
        if self.drop_attn:
            ...
            self.self_attn = Gemma3Attention(config=config, layer_idx=layer_idx, kv_cache_idx=self.kv_cache_idx)
