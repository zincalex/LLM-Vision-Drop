...
from transformers.modeling_outputs import BackboneOutput, BaseModelOutputWithPooling
...
from .configuration_dropped_dinov3 import DINOv3ViTConfig
...
class DINOv3ViTLayer(GradientCheckpointingLayer):
    ...
    def __init__(self, config: DINOv3ViTConfig, layer_idx: int):
        super().__init__()
...
class DINOv3ViTModel(DINOv3ViTPreTrainedModel):
    def __init__(self, config: DINOv3ViTConfig):
        ...
        self.layer = nn.ModuleList([DINOv3ViTLayer(config, layer_idx=i) for i in range(config.num_hidden_layers)])
