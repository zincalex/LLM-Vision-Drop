...
class Gemma2Attention(nn.Module):
    ...
    def __init__(self, config: Gemma2Config, layer_idx: int, kv_cache_idx: Optional[int] = None):
        super().__init__()
...
class Gemma2DecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: Gemma2Config, layer_idx: int):
        ...
        if self.drop_attn:
            ...
            self.self_attn = Gemma2Attention(config=config, layer_idx=layer_idx, kv_cache_idx=self.kv_cache_idx)
